...
import { CheckIcon, CopyIcon, Trash2Icon, VariableIcon } from "lucide-react"
...
export function WorkflowInspectorSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        className="flex w-full flex-col gap-0 space-y-0 sm:max-w-md"
                ...
                <Field>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="message.received">
            ...
            {tone === "condition" && (
              <FieldGroup className="gap-4 pt-4 border-t">
                <div className="rounded-lg bg-amber-500/10 border border-amber-500/20 p-3 text-xs text-amber-700 dark:text-amber-300">
                  <strong>Branching Note:</strong> If this condition matches,
                  the workflow proceeds through the{" "}
                  <strong>True (Green)</strong> handle. Otherwise, it proceeds
                  through <strong>False (Amber)</strong>.
                </div>
              ...
              <FieldGroup className="gap-4 pt-4 border-t">
                ...
                <Field>
                  ...
                  <FieldDescription>
                    ...
                    <code>&#123;&#123;trigger.driver&#125;&#125;</code> and{" "}
                    <code>
                      &#123;&#123;node-ai-extract.output.summary&#125;&#125;
                    </code>
                    .
                  </FieldDescription>
                </Field>
