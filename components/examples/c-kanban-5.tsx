...
const COLUMNS: Record<string, { title: string; color: string }> = {
  planned: { title: "Planned", color: "bg-primary" },
  building: { title: "Building", color: "bg-warning" },
  testing: { title: "Testing", color: "bg-info" },
  shipped: { title: "Shipped", color: "bg-success" },
}
...
export function KanbanRoadmap() {
    ...
    testing: [
      {
        ...
        description: "Validation rules for imports and enriched records",
        progress: 85,
        votes: 121,
      },
    ],
  ...
  return (
    ...
    >
      <KanbanBoard className="grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
