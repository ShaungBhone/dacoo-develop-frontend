...
function DataGridTableHeadRowCell<TData extends object>({
  ...
  return (
    <th
      ...
      className={cn(
        "text-foreground relative h-10 p-0 text-left align-middle font-medium rtl:text-right [&:has([role=checkbox])]:pe-0",
        ...
        className: cn(
          ...
          isLastVisibleColumn
            ...
            : isPinned
              ...
              : "-end-2 w-5 justify-center before:absolute before:inset-y-0 before:end-2 before:w-px before:bg-border",
