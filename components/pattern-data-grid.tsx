...
export function Pattern() {
  ...
  const [settledRequestId, setSettledRequestId] = useState(-1)
  const isLoading = currentRequestId !== settledRequestId

  useEffect(() => {
    const t = setTimeout(() => {
      setData(demoData)
      setSettledRequestId(currentRequestId)
    }, 700)
