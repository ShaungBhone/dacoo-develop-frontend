...
/**
 * Base UI's GroupLabel throws unless it sits inside a Menu.Group, where Radix's
 * Label could stand alone. Providing the Group here keeps the shadcn API — a
 * label usable anywhere in a menu — without every call site having to wrap it.
 */
